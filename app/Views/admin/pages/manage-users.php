...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black"
    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Manage System Users</a></li>
            </ol>
        </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <ul class="nav nav-pills mix-chart-tab user-m-tabe" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" data-series="list" id="pills-week-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-list" type="button" role="tab"
                                    aria-selected="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                        class="svg-main-icon">
                        ...
                        <a  data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample" class="btn btn-primary btn-sm ms-2">+ Add User</a>
                    </div>
                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="card-use-box">
                                                <div class="crd-bx-img">
                                                    <img style="width: 100px;" src="/public/v2/images/contacts/<?=$user['employee_passport']?>"
                                                        class="rounded-circle" alt="">
                                                    <div class="active <?php if($user['user_status'] == 0){echo"deactive";} ?>"></div>
                                                </div>                                                
                                                <div class="card__text">
                                                    <h4 class="mb-0"><?=$user['user_fullname']?></h4>
                                                    <p><?=$user['user_phone']?></p>
                                                    <p><?=$user['user_email']?></p>
                                                </div>
                                                ...
                                                <ul class="post-pos">
                                                    <li>
                                                        ...
                                                        <span><?=ucfirst($user['user_role'])?></span>
                                                    </li>
                                                    <li>
                                                        <span class="card__info__stats">Joining Date: </span>
                                                        <span><?=$user['user_created_at']?></span>
                                                    </li>
                                                </ul>
                                                <div>
                                                <?php
                                                    ...
                                                    <td>
                                                        <div class="form-check custom-checkbox">
                                                            ...
                                                            <label class="form-check-label"
                                                                for="customCheckBox222"></label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/public/v2/images/contacts/<?=$user['employee_passport']?>"
                                                                class="avatar rounded-circle" alt="">
                                                            <p class="mb-0 ms-2"><?=$user['user_fullname']?></p>
                                                        </div>
                                                    </td>
            ...
            <form id="userForm">
                <div class="row">                    
                    <div class="col-xl-12 mb-12">
                        <label for="employee" class="form-label">Select An Employee<span class="text-danger">*</span></label>
                    ...
                    <div class="col-xl-6 mb-6">
                        ...
                        <input type="email" class="form-control" id="email" readonly name="email" placeholder="">
                    </div>
                    <div class="col-xl-6 mb-6">
                    ...
                    <div class="col-xl-6 mb-6">
                        ...
                        <input type="password" class="form-control" id="dz-password" name="dz-password" placeholder="12345">
    ...
    ***********************************-->
    ...
    <script src="https://w3crm.dexignzone.com/codeigniter/demo/public/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    ...
    <script src="/public/v2/js/auth/users.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('submit','#userForm',function(e){
                ...
                var role = $('#role').val();
                if(email == "" || phone == ""){
                    toastr.error('Select another employee', "Error!", {
                    positionClass: "toast-top-right",
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
                    ...
                    toastr.error('Enter the user default password', "Error!", {
                    positionClass: "toast-top-right",
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
                    ...
                    hideMethod: "fadeOut",
                    tapToDismiss: !1
                });$('#dz-password').focus(); return;
                } else if(role == ""){
                    toastr.error('Select the user role', "Error!", {
                    positionClass: "toast-top-right",
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
                    ...
                    $.ajax({
                    type: "POST",
                    url: "/admin/dashboard/employee/add-user",
                    cache: false,
