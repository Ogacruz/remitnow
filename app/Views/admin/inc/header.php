											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="/public/v2/images/avatar/1.jpg">
													</div>
									...
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											<div class="header-media">
												<img src="/public/api/img/logo.jpg" alt="">
											</div>
											<div class="header-info">
												<h6><?=session()->get('user_fullname')?></h6>
									...
									<div class="dropdown-menu dropdown-menu-end">
										<div class="card border-0 mb-0">
											<div class="card-header py-2">
												<div class="products">
													<img src="/public/api/img/logo.jpg" class="avatar avatar-md" alt="">
													<div>
														<h6><?=session()->get('user_fullname')?></h6>
											...
											<div class="card-body px-0 py-2">
												<a href="/admin/dashboard/app-profile" class="dropdown-item ai-icon ">
												...
												<a href="/admin/dashboard/my-projects" class="dropdown-item ai-icon ">
											...
											<div class="card-footer px-0 py-2">
												...
												<a href="/user/auth/logout" class="dropdown-item ai-icon">
