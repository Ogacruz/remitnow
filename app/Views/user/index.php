...
<body>
    ...
    <div class="toast pwa-install-alert shadow bg-white" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="5000" data-bs-autohide="true">
        <div class="toast-body">
            <div class="content d-flex align-items-center mb-2"><img src="/public/api/img/logo.jpg" style="border-radius: 100px;" alt="">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="container">
            <div class="search-form pt-3 rtl-flex-d-row-r">
                <form action="/user/dashboard/search" method="post">
                    <input class="form-control" name="search" type="search" placeholder="Searching for property">
                    <button type="submit"><i class="ti ti-search"></i></button>
                </form>
                <!-- Alternative Search Options -->
                <div class="">
                    <a class="filter-option ms-2 btn btn-primary" id="altSearchOption" href="#" role="button" data-bs-toggle="offcanvas" data-bs-target="#suhaFilterOffcanvas" aria-controls="suhaFilterOffcanvas"><i class="ti ti-adjustments-horizontal"></i></a>
                </div>
            </div>
                        ...
                        <div class="single-hero-slide" style="background-image: url('/public/api/img/bg-img/1.jpg')">
                            <div class="slide-content h-100 d-flex align-items-center">
                                <div class="slide-text">
                                    ...
                                    <a class="btn btn-primary" href="/user/dashboard/buy/products" data-animation="fadeInUp" data-delay="800ms" data-duration="1000ms">Buy
                                        Now</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-hero-slide" style="background-image: url('/public/api/img/bg-img/2.jpg')">
                            <div class="slide-content h-100 d-flex align-items-center">
                                <div class="slide-text">
                                    ...
                                    <a class="btn btn-success" href="/user/dashboard/buy/products" data-animation="fadeInUp" data-delay="500ms" data-duration="1000ms">Buy Now</a>
                                </div>
                            </div>
                        </div>
                        <!-- Single Hero Slide-->
                        <div class="single-hero-slide" style="background-image: url('/public/api/img/bg-img/3.jpg')">
                            <div class="slide-content h-100 d-flex align-items-center">
                                <div class="slide-text">
                                    ...
                                    <p class="text-white" data-animation="fadeInUp" data-delay="400ms" data-duration="1000ms">3 years warranty</p>
                                    <a class="btn btn-danger" href="/user/dashboard/buy/products" data-animation="fadeInUp" data-delay="800ms" data-duration="1000ms">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card catagory-card">
                                    <div class="card-body px-2">
                                        <a href="/user/dashoard/catagory/<?= $cat->businesscategoryID ?>/listing">
                                            <img src="/public/api/img/core-img/<?= $cat->businesscategory_image ?>" alt=""><span><?= $cat->businesscategory_name ?></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="top-products-area py-3">
            <div class="container">
                <div class="section-heading d-flex align-items-center justify-content-between dir-rtl">
                    <h6>Top Products</h6><a class="btn btn-sm btn-light" href="/user/dashboard/products/all-top-products">View all<i class="ms-1 ti ti-arrow-right"></i></a>
                </div>
                <div class="row g-2">
                    <!-- Product Card -->
                    <?php
                                ...
                                <div class="card product-card">
                                    <div class="card-body">
                                        ...
                                        <a class="product-thumbnail d-block" href="/user/dashboard/products/buy/<?= $t->productID ?>/<?= strtolower(str_replace(' ', '-', $t->product_name)) ?>">
                                            ...
                                            <?php
                                            if ($t->product_isflash != "") {
                                                $orgDate = $t->product_isflash;
                                                $newDate = date("Y/m/d", strtotime($orgDate));    ?>
                                                <ul class="offer-countdown-timer d-flex align-items-center shadow-sm" data-countdown="<?= $newDate ?> 23:59:59">
                                        ...
                                        <!-- Product Title --><a class="product-title" href="/user/dashboard/products/buy/<?= $t->productID ?>/<?= strtolower(str_replace(' ', '-', $t->product_name)) ?>"><?= $t->product_name ?></a>
                                        <!-- Product Price -->
        ...
        <div class="container">
            <div class="cta-text dir-rtl p-4 p-lg-5">
                <div class="row">
                    <div class="col-9">
                        <h5 class="text-white">20% discount on women's care items.</h5><a class="btn btn-warning" href="#">Grab this offer</a>
                    </div>
                                ...
                                <div class="card horizontal-product-card">
                                    <div class="d-flex align-items-center">
                                        <div class="product-thumbnail-side">
                                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="/user/dashboard/products/buy/<?= $t->productID ?>/<?= strtolower(str_replace(' ', '-', $t->product_name)) ?>">
                                                <?php
                                                $photo->where('file_product_id', $t->productID)->orderBy('fileuploadID', 'RANDOM')->limit(1);
                                                $query = $photo->get();
                                                if ($query->getNumRows() > 0) {
                                        ...
                                        <div class="product-description">
                                            <!-- Product Title --><a class="product-title d-block" href="/user/dashboard/products/buy/<?= $t->productID ?>/<?= strtolower(str_replace(' ', '-', $t->product_name)) ?>"><?= $t->product_name ?></a>
                                            <!-- Price -->
                                            <p class="sale-price"><i class="fa fa-money"></i>
                                                &#x20A6;<?= number_format($t->product_current_price) ?><span>&#x20A6;<?= number_format($t->product_old_price) ?></span>
                                            </p>
                                            <!-- Rating -->
                                            <div class="product-rating"><i class="ti ti-star-filled"></i>4.88 <span class="ms-1">(39 review)</span>
                                        </div>
        ...
        <div class="featured-products-wrapper py-3">
            <div class="container">
                <div class="section-heading d-flex align-items-center justify-content-between dir-rtl">
                    <h6>Featured Products</h6><a class="btn btn-sm btn-light" href="/user/dashboard/products/all-featured-products">View all<i class="ms-1 ti ti-arrow-right"></i></a>
                </div>
                <div class="row g-2">
                        ...
                        foreach ($featured as $key => $t) { ?>
                            ...
                            <div class="col-4">
                                <div class="card featured-product-card">
                                    ...
                                    <div style="text-align: right; padding-right:5 px; padding-bottom:5px;">
                                            <button 
                                        product_id="<?=$t->productID?>"
                                        product_name="<?=$t->product_name?>"
                                        product_price="<?=$t->product_current_price?>"
        ...
        <div class="pb-3">
            <div class="container">
                <div class="section-heading d-flex align-items-center justify-content-between dir-rtl">
                    <h6>Brand Collections</h6><a class="btn btn-sm btn-light" href="#">
                        View all<i class="ms-1 ti ti-arrow-right"></i></a>
                </div>
                <!-- Collection Slide-->
                <div class="collection-slide owl-carousel">
                    ...
                    $prods->orderBy('productID', 'RANDOM')->groupBy('product_brand')->limit(100);
                    $query = $prods->get();
                    if ($query->getNumRows() > 0) {
                        foreach ($query->getResult() as $row) { ?>
                            <?php
                            $photo->where('file_product_id', $row->productID)->orderBy('fileuploadID', 'RANDOM')->limit(1);
                            $query = $photo->get();
                            if ($query->getNumRows() > 0) {
                                foreach ($query->getResult() as $pxi) { ?>

                                    <div class="card collection-card"><a href="/user/dashoard/brand/<?= strtolower($row->product_brand) ?>">
                                            <img src="/public/api/img/product/new/<?= $pxi->file_name ?>" alt=""></a>
                                        <div class="collection-title"><span><?= $row->product_brand ?></span><span class="badge bg-danger">
                                                <?php
                                                $prods->where(['product_brand' => $row->product_brand]);
                                                $p =  $prods->countAllResults();
