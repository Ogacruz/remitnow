    ...
    <div class="page-content-wrapper">
        <div class="product-slide-wrapper">
            ...
            <div class="product-slides owl-carousel">
                <!-- Single Hero Slide-->
                <?php
                    $photo->where('file_product_id', $prod->productID)->orderBy('fileuploadID', 'RANDOM');
                    $query = $photo->get();
                    if ($query->getNumRows() > 0) {
                        foreach ($query->getResult() as $row) { ?>
                            <!-- <img class=" single-product-slide" style="width:300px;" src=""  alt=""> -->
                            <div class="single-product-slide"  style="background-image: url(/public/api/img/product/new/<?= $row->file_name ?>)"></div>
                    <?php    }
                    }
                    ?>
            </div>
        ...
        <div class="product-description pb-3">
            ...
            <div class="product-title-meta-data bg-white mb-3 py-3">
                <div class="container d-flex justify-content-between rtl-flex-d-row-r">
                    <div class="p-title-price">
                        <h5 class="mb-1"><?=$prod->product_name?></h5>
                        <p class="sale-price mb-0 lh-1">&#x20A6;<?=number_format($prod->product_current_price)?><span>&#x20A6;<?=number_format($prod->product_old_price)?></span></p>
                    </div>
                    ...
                    <div class="sales-offer-content d-flex align-items-end justify-content-between">
                        ...
                        <div class="sales-end">
                            <p class="mb-1 font-weight-bold"><i
                                    class="ti ti-bolt-lightning lni-flashing-effect text-danger"></i> Flash sale end in
                            </p>
                            <!-- Please use event time this format: YYYY/MM/DD hh:mm:ss-->
                            <ul class="sales-end-timer ps-0 d-flex align-items-center"
                                data-countdown="2025/01/01 14:21:37">
            ...
            <!-- Product Video -->
            <div class="bg-img" style="background-image: url(/public/api/img/product/18.jpg)">
                <div class="container">
                    ...
                    <div class="related-product-slide owl-carousel">
                        <div class="card product-card bg-gray shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        class="mb-2" src="/public/api/img/product/11.png" alt="">
                        ...
                        <div class="card product-card bg-gray shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Wishlist Button--><a class="wishlist-btn" href="#"><i class="ti ti-heart"> </i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        class="mb-2" src="/public/api/img/product/5.png" alt=""></a>
                        ...
                        <div class="card product-card bg-gray shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Wishlist Button--><a class="wishlist-btn" href="#"><i class="ti ti-heart"> </i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        class="mb-2" src="/public/api/img/product/6.png" alt=""></a>
                        ...
                        <div class="card product-card bg-gray shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Wishlist Button--><a class="wishlist-btn" href="#"><i class="ti ti-heart"> </i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        class="mb-2" src="/public/api/img/product/9.png" alt="">
                                    <!-- Offer Countdown Timer: Please use event time this format: YYYY/MM/DD hh:mm:ss -->
                                    <ul class="offer-countdown-timer d-flex align-items-center shadow-sm"
                        ...
                        <div class="card product-card bg-gray shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Wishlist Button--><a class="wishlist-btn" href="#"><i class="ti ti-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        class="mb-2" src="/public/api/img/product/8.png" alt=""></a>
                                <!-- Product Title --><a class="product-title" href="single-product.html">Wooden
                                    Chair</a>
                                <!-- Product Price -->
                        ...
                        <div class="card product-card bg-gray shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Wishlist Button--><a class="wishlist-btn" href="#"><i class="ti ti-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        class="mb-2" src="/public/api/img/product/4.png" alt=""></a>
                    ...
                    <div class="rating-review-content">
                        <ul class="ps-0">
                            ...
                            <li class="single-user-review d-flex">
                                <div class="user-thumbnail"><img src="/public/api/img/bg-img/7.jpg" alt=""></div>
                                <div class="rating-comment">
                                    ...
                                    <p class="comment mb-0">Very good product. It's just amazing!</p><span
                                        ...
                                        href="/public/api/img/product/3.png"><img class="rounded-3"
                                            src="/public/api/img/product/3.png" alt=""></a>
                                </div>
                            </li>
                            <!-- Single User Review -->
                            <li class="single-user-review d-flex">
                                <div class="user-thumbnail"><img src="/public/api/img/bg-img/8.jpg" alt=""></div>
                                <div class="rating-comment">
                                    <div class="rating"><i class="ti ti-star-filled"></i><i
                                            class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i
                                            class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i></div>
                                    <p class="comment mb-0">Very excellent product. Love it.</p><span
                                        ...
                                        class="review-image mt-2 border rounded"
                                        href="/public/api/img/product/4.png"><img class="rounded-3"
                                            src="/public/api/img/product/4.png" alt=""></a><a
                                        class="review-image mt-2 border rounded"
                                        href="/public/api/img/product/6.png"><img class="rounded-3"
                                            src="/public/api/img/product/6.png" alt=""></a>
                                </div>
                            </li>
                            <!-- Single User Review -->
                            <li class="single-user-review d-flex">
                                <div class="user-thumbnail"><img src="/public/api/img/bg-img/9.jpg" alt=""></div>
                                <div class="rating-comment">
                                    <div class="rating"><i class="ti ti-star-filled"></i><i
                                            class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i
                                            class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i></div>
