...
<?php foreach ($infos as $key => $info) {} ?>
  ...
  <body>
          ...
          <div class="card user-data-card">
            <div class="card-body">
              <form id="changePasswordForm">
                <div class="mb-3">
                  <div class="title mb-2"><i class="ti ti-key"></i><span>Current Password</span></div>
                  <input class="form-control" id="userid" value="<?=$info->userID?>" name="userid" type="hidden">
                  <input class="form-control" id="recap" value="<?=$info->user_recap?>" name="recap" type="hidden">
                  <input class="form-control" id="oldpass" name="oldpass" type="password" placeholder="Current password">
                  <span toggle="#oldpass" class="fa fa-fw fa-eye-slash field-icon toggle-password"></span>
                </div>
                <div class="mb-3">
                  <div class="title mb-2"><i class="ti ti-key"></i><span>New Password</span></div>
                  <input class="input-psswd form-control" id="registerPassword" name="registerPassword" type="New password" placeholder="New password">
                  <span toggle="#registerPassword" class="fa fa-fw fa-eye-slash field-icon toggle-password"></span>
                </div>
                <div class="mb-3">
                  <div class="title mb-2"><i class="ti ti-key"></i><span>Repeat New Password</span></div>
                ...
                <button class="btn btn-success w-100" id="btnUpdate" type="submit">Update Password</button>
              </form>
            </div>
          </div>
        </div>
    ...
    <script src="/public/api/js/ogadan/change-password.js"></script>
    <script>
