...
<div class="sidenav-profile">
    <div class="user-profile"><img src="/public/v1/assets/images/uploads/<?=$info->user_passport?>" alt=""></div>
    <div class="user-info">
        <h5 class="user-name mb-1 text-white"><?=session()->get('user_fullname')?></h5>
        <p class="available-balance text-white">Bal. &#8358;<span
                class="counter"><?=number_format($info->wallet_bal,2)?></span></p>
    </div>
</div>
<!-- Sidenav Nav-->
